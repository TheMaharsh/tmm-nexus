...
class GoogleMapsScraper(BaseScraper):
    ...
    async def search(
        ...
        async with self.browser.page() as page:
            ...
            await results_feed.wait_for(timeout=20000)
            ...
            print(f"\nCollected {count} business cards.\n")
            ...
            print("Saved results.html and results.png")
    ...
    async def _search(
        ...
        await search_box.wait_for(timeout=20000)
